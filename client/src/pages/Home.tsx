...
const Home = () => {
  ...
  const [selectedColor, setSelectedColor] = useState<PersonalColorType | undefined>();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section id="home" className="bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-gray-400 mb-4">
                퍼스널 컬러 분석을 통해 당신만의 완벽한 스타일을 찾아보세요.<br />
            ...
            <div>
              ...
              <ul className="text-gray-400 space-y-2">
                <li><a href="#" className="hover:text-white transition-colors">퍼스널 컬러 진단</a></li>
                <li><a href="#" className="hover:text-white transition-colors">컬러 팔레트</a></li>
                <li><a href="#" className="hover:text-white transition-colors">스타일링 가이드</a></li>
              </ul>
            </div>
            <div>
